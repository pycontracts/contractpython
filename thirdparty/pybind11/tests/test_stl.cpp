...
TEST_SUBMODULE(stl, m)
{
    ...
    m.def("test_no_assign", [](const opt_no_assign &x) { return x ? x->value : 42; },
    ...
    m.def("test_no_assign_exp", [](const exp_opt_no_assign &x) { return x ? x->value : 42; },
          py::arg_v("x", std::experimental::nullopt, "None"));
#endif
    ...
    py::class_<Issue1561Inner>(m, "Issue1561Inner").def(py::init<std::string>()).def_readwrite("data", &Issue1561Inner::data);
