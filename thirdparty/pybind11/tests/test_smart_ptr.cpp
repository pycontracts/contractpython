...
TEST_SUBMODULE(smart_ptr, m)
{
    ...
    py::class_<MyObject5, huge_unique_ptr<MyObject5>>(m, "MyObject5").def(py::init<int>()).def_readwrite("value", &MyObject5::value);
    ...
    py::class_<TypeForMoveOnlyHolderWithAddressOf, MoveOnlyHolderWithAddressOf>(m,
                                                                                "TypeForMoveOnlyHol"
                                                                                "derWithAddressOf")
    .def_static("make",
                []() {
    ...
    py::class_<ElementA, ElementBase, std::shared_ptr<ElementA>>(m, "ElementA").def(py::init<int>()).def("value", &ElementA::value);
