...
void vector_if_equal_operator(enable_if_t<is_comparable<Vector>::value, Class_> &cl)
{
    ...
    cl.def("count", [](const Vector &v, const T &x) { return std::count(v.begin(), v.end(), x); },
...
void vector_modifiers(enable_if_t<is_copy_constructible<typename Vector::value_type>::value, Class_> &cl)
{
    ...
    cl.def("append", [](Vector &v, const T &value) { v.push_back(value); }, arg("x"),
    ...
    cl.def("extend", [](Vector &v, const Vector &src) { v.insert(v.end(), src.begin(), src.end()); },
...
template <typename Map, typename Class_>
void map_assignment(
enable_if_t<!std::is_copy_assignable<typename Map::mapped_type>::value && is_copy_constructible<typename Map::mapped_type>::value, Class_> &cl)
{
    using KeyType = typename Map::key_type;
    using MappedType = typename Map::mapped_type;
...
class_<Map, holder_type> bind_map(handle scope, const std::string &name, Args &&... args)
{
    ...
    cl.def("__iter__", [](Map &m) { return make_key_iterator(m.begin(), m.end()); },
           keep_alive<0, 1>() /* Essential: keep list alive while iterator exists */
    );
