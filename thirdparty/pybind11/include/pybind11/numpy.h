...
template <typename T>
using is_pod_struct =
all_of<std::is_standard_layout<T>, // since we're accessing directly in memory we need a standard layout type
...
public:
          ...
          handle base = handle())
    {
        ...
        api.PyArray_NewFromDescr_(api.PyArray_Type_, descr.release().ptr(), (int)ndim, shape->data(),
...
protected:
    ...
    static PyObject *raw_array(PyObject *ptr, int ExtraFlags = 0)
    {
        ...
        return detail::npy_api::get().PyArray_FromAny_(ptr, nullptr, 0, 0,
...
template <typename T> struct npy_format_descriptor_name<T, enable_if_t<std::is_integral<T>::value>>
{
    ...
    _<std::is_same<T, bool>::value>(_("bool"),
...
{
    ndim =
    std::accumulate(buffers.begin(), buffers.end(), ssize_t(0),
...
private:
    ...
    static_assert(NVectorized >= 1, "pybind11::vectorize(...) requires a function with at least one vectorizable argument");
...
private:
    ...
    using param_n_t = typename pack_element<Index, typename vectorize_arg<Args>::call_type...>::type;
                       ...
                       index_sequence<BIndex...>)
    {
        ...
        std::array<std::pair<unsigned char *&, const size_t>, NVectorized> vecparams{
            { std::pair<unsigned char *&, const size_t>(reinterpret_cast<unsigned char *&>(
