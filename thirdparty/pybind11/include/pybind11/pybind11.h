...
#pragma GCC diagnostic pop
        ...
        static_assert(expected_num_args<Extra...>(sizeof...(Args), cast_in::has_args, cast_in::has_kwargs),
                      "The number of argument annotations does not match the number of function "
                      "arguments");
        ...
        rec->impl = [](function_call &call) -> handle {
            ...
            handle result =
            cast_out::cast(std::move(args_converter).template call<Return, Guard>(cap->f), policy,
                           call.parent);
...
public:
    ...
    template <typename... Extra> class_(handle scope, const char *name, const Extra &... extra)
    {
        ...
        static_assert(none_of<is_pyobject<Extra>...>::value || // no base class arguments, or:
                      ...
                      "Error: multiple inheritance bases must be specified via class_ template "
                      "options");
    ...
    def_property_static(const char *name, const cpp_function &fget, const cpp_function &fset, const Extra &... extra)
    {
        ...
        {
            char *doc_prev =
            rec_fget->doc; /* 'extra' field may include a property-specific documentation string */
...
struct enum_base
{
    ...
    PYBIND11_NOINLINE void init(bool is_arithmetic, bool is_convertible)
    {
        ...
        m_base.attr("__doc__") =
        static_property(cpp_function([](handle arg) -> std::string {
...
#endif
        cpp_function setstate([](Type &value, Scalar arg) { value = static_cast<Type>(arg); },
                              is_method(*this));
